class CreateNew2s < ActiveRecord::Migration[5.2]
  def change
    create_table :jtkgbs do |t|
    ...
    add_index :jtkgbs, :id, unique: true
    ...
    add_index :jtkpvs, :id, unique: true
